...
public class BahmniPatientDaoImplLuceneIT extends BaseIntegrationTest {
    ...
    public void shouldSearchSimilarPatientByPatientName() {
        List<PatientResponse> patients = patientDao.getSimilarPatientsUsingLuceneSearch("Peet", "", null, "c36006e5-9fbb-4f20-866b-0ece245615a1", 5);
    ...
    public void shouldSearchSimilarPatientByPatientNameAndGender() {
        List<PatientResponse> patients = patientDao.getSimilarPatientsUsingLuceneSearch("Peet", "F", null, "c36006e5-9fbb-4f20-866b-0ece245615a1", 5);
    ...
    @Test
    public void shouldSearchSimilarPatientByNameAndBirthdate() {
        Date birthdate = Timestamp.valueOf("1983-01-30 00:00:00");

        List<PatientResponse> patients = patientDao.getSimilarPatientsUsingLuceneSearch("Sinha", "", birthdate, "c36006e5-9fbb-4f20-866b-0ece245615a1", 5);
